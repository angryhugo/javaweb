...
/**
 * Servlet implementation class QueryCustomerForS
 */
@WebServlet("/QueryCustomerForS")
public class QueryCustomerForS extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QueryCustomerForS() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<BODY>");
		out.println("<p align='center' class='style1'>客户信息自定义查询</p>");
		out.println("<form action='QueryCustomerForS'><p class='style2'>姓名关键字：<input name='name' type='text' size='12'/><input type='submit' value='查询' /></p></form>");
	    if(name!=null)
	    {
	    	...
	    	try {
				s=search.search_customer_forS(sql);
			} catch (Exception e) {
