...
/**
 * Servlet implementation class UpdPsw_M
 */
@WebServlet("/UpdPsw_M")
public class UpdPsw_M extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String mname=(String) session.getAttribute("用户名");
		out.println("<HTML>");
		...
		out.println("<form id=\"form1\" name=\"form1\" action='UpdPsw_M'>");
		out.print("<table width=\"29%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">");
		out.print("<tr><td>用户名：</td><td><input name='id' type='text' readonly='readonly' value='"+mname+"' size='12'/>");
		...
		if(mname!=null && opsw!=null && npsw1!=null)
		{
			try {
				if(manager.checkManager(mname, opsw))
				{
					String sql="update manager set Mpassword='"+npsw1+"' where Mname='"+mname+"'";
					if(update.doIDU(sql))
